initialize <- function(inits,params){
  ...
  total <- 0
  if (S.rNC.init > 0){
    S.rNC=as.data.frame(cbind("ID"=1:S.rNC.init,"VL"=rep(NA,S.rNC.init))) # can adjust if want to vary this
  ...
  if (E.rNC.init > 0){
    ...
    E.rNC=as.data.frame(cbind("ID"=as.numeric(),"VL"=as.numeric(),"Inc.pd"=as.numeric(),"Days"=as.numeric())) 
  }
  ...
  if (R.rNC.init > 0){
    ...
    R.rNC=as.data.frame(cbind("ID"=as.numeric(),"VL"=as.numeric(), "VL_waning"=as.numeric(), "Rec.days"=as.numeric()))
  }
  ...
  if (I.rC.init > 0){
    I.rC=as.data.frame(cbind("ID"=(total+1):(total+ I.rC.init),"VL_rise" = round(runif(I.rC.init, 1, 4)),
                             ...
                             "Infectiousness"=rep(1,I.rC.init)))
  ...
  if (R.rC.init > 0){
    ...
    R.rC=as.data.frame(cbind("ID"=as.numeric(),"VL"=as.numeric(),"VL_waning"=as.numeric(),"Rec.days"=as.numeric())) 
  }
  
  if (S.hcwNC.init > 0){
    S.hcwNC=as.data.frame(cbind("ID"=(total+1):(total + S.hcwNC.init),"VL"=rep(NA,S.hcwNC.init))) # can adjust if want to vary this
    total <- total + S.hcwNC.init
  } else{
    S.hcwNC=as.data.frame(cbind("ID"=as.numeric(),"Infectiousness"=as.numeric())) 
  }
  ...
  if (E.hcwNC.init > 0){
    ...
    E.hcwNC=as.data.frame(cbind("ID"=as.numeric(),"VL"=as.numeric(),"Inc.pd"=as.numeric(),"Days"=as.numeric())) 
  }
  ...
  if (R.hcwNC.init > 0){
    ...
    R.hcwNC=as.data.frame(cbind("ID"=as.numeric(),"VL"=as.numeric(),"VL_waning"=as.numeric(),"Rec.days"=as.numeric())) 
  }
  
  if (S.hcwC.init > 0){
    S.hcwC=as.data.frame(cbind("ID"=(total+1):(total + S.hcwC.init),"VL"=rep(NA,S.hcwC.init))) # can adjust if want to vary this
    total <- total + S.hcwC.init
  } else{
    S.hcwC=as.data.frame(cbind("ID"=as.numeric(),"Infectiousness"=as.numeric())) 
  }
  ...
  if (E.hcwC.init > 0){
    ...
    E.hcwC=as.data.frame(cbind("ID"=as.numeric(),"VL"=as.numeric(),"Inc.pd"=as.numeric(),"Days"=as.numeric())) 
  }
  ...
  if (R.hcwC.init > 0){
    ...
    R.hcwC=as.data.frame(cbind("ID"=as.numeric(),"VL"=as.numeric(),"VL_waning"=as.numeric(), "Rec.days"=as.numeric()))
  }
